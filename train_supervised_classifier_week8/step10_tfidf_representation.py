...
#load the datasets we prepared from step 9
...
#still have raw text, need to define a TF-IDF vectorizer

vectorizer = TfidfVectorizer(
    lowercase=True,
    min_df=5,        # ignore very rare words (words that appear in fewer than 5 docs)
    max_df=0.9       # ignore extremely common words (words that appear in more than 90% of docs)
)
...
#each text chunk is now a numeric vector
